...
{{ join "" (list $countInDifferentDataCenters $countInSameDataCenterButDifferentRacks $countInSameDataCenterButDifferentRacks | toStrings) }}
{{- end -}}
{{- end -}}

{{/*
ref: https://github.com/bitnami/charts/blob/main/bitnami/common/templates/_tplvalues.tpl
